(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_9a8b9693._.js", {
...
const API_URL = ("TURBOPACK compile-time falsy", 0) ? ("TURBOPACK unreachable", undefined) : ("TURBOPACK compile-time value", "http://localhost:8080/api/v1") || "http://localhost:8080/api/v1"; // URL pour le navigateur
const AUTH_URL = ("TURBOPACK compile-time falsy", 0) ? ("TURBOPACK unreachable", undefined) : ("TURBOPACK compile-time value", "http://localhost:8081/api/v1") || "http://localhost:8081/api/v1"; // URL pour le navigateur
...
async function getArticles() {
    try {
        ...
        checkAuth();
        console.log('Environment:', ("TURBOPACK compile-time falsy", 0) ? ("TURBOPACK unreachable", undefined) : 'client');
...
function AuthProvider({ children }) {
    ...
    const login = async (username, password)=>{
        ...
        setError(null);
        try {
            const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["login"])(username, password);
...
//# sourceMappingURL=_9a8b9693._.js.map