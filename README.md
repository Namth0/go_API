...
- [Projet Programmation Web - M1 Cybersécurité](#projet-programmation-web---m1-cybersécurité)
  ...
  - [2. Architecture Globale](#2-architecture-globale)
    ...
    - [2.2 Services Backend (Go)](#22-services-backend-go)
      - [2.2.1 Service d'Articles API (Port 8080)](#221-service-darticles-api-port-8080)
        - [Routes pour les articles](#routes-pour-les-articles)
      - [2.2.2 Service d'Authentification (Port 8081)](#222-service-dauthentification-port-8081)
        - [Routes pour les utilisateurs](#routes-pour-les-utilisateurs)
    - [2.3 Infrastructure](#23-infrastructure)
      - [Diagramme de l'infrastructure complète](#diagramme-de-linfrastructure-complète)
  ...
  - [ Google Labs](#-google-labs)
    - [Labs Martin RIGAUX](#labs-martin-rigaux)
    - [Labs Othman BENCHERIF](#labs-othman-bencherif)
  - [Critères d'évaluations (par ordre décroissant d'importance) :](#critères-dévaluations-par-ordre-décroissant-dimportance-)
